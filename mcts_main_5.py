...
class MCTSNode:
    ...
    def best_child(self, c_param=1.41):
        ...
        # # Print the values of choices_weights, total_reward, and visits for debugging
        # print("\n--- Debugging best_child ---")
        # for i, child in enumerate(self.children):
        #     print(f"Child {i}: Total Reward = {child.total_reward}, Visits = {child.visits}, Weight = {choices_weights[i]}")
        # print("----------------------------")
...
class MCTS:
    ...
    def search(self, root_env, rootnodeid):
        ...
        print(f"Selected Action: {root_node.most_visited_child().action}")
...
def main():
    ...
    mcts = MCTS(exploration_weight=1.41, iterations=50)
    ...
    for i in tqdm(range(2), desc='---Apply MCTS planning on the test environment:'):
